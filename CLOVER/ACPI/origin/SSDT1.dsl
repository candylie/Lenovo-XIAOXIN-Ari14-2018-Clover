 ...
 *
 * Disassembly of SSDT1.aml, Sun Oct 14 20:26:37 2018
 *
        ...
        Device (TPM)
        {
            ...
            Method (_CRS, 0, Serialized)  // _CRS: Current Resource Settings
            {
                If (LNotEqual (PTTB, 0xFED40040))
                {
                    ...
                    CreateDWordField (CRS0, \_SB.TPM._CRS._Y2D._BAS, CBAS)  // _BAS: Base Address
                    Store (PTTB, CBAS)
                    Return (CRS0)
                }
                Else
            ...
            OperationRegion (TNVS, SystemMemory, 0x6FF6D000, 0x26)
