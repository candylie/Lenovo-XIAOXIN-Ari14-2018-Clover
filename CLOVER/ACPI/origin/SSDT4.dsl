 ...
 *
 * Disassembly of SSDT4.aml, Sun Oct 14 20:26:41 2018
 *
...
DefinitionBlock ("", "SSDT", 2, "LENOVO", "CB-01   ", 0x00000001)
{
    ...
    External (_SB_.PCI0.LPCB.EC0_.RTMP, UnknownObj)    // (from opcode)
    External (_SB_.PCI0.LPCB.EC0_.VTMP, UnknownObj)    // (from opcode)
    ...
    External (UMAB, UnknownObj)    // (from opcode)
    ...
    Scope (\_SB.PCI0.B0D4)
    {
        ...
        Method (_TMP, 0, Serialized)  // _TMP: Temperature
        {
            If (LEqual (UMAB, Zero))
            {
                Return (\_SB.IETM.CTOK (\_SB.PCI0.LPCB.EC0.VTMP))
            }
            Else
            {
    ...
    Scope (\_SB.IETM)
    {
        ...
        {
            Store (\_SB.IETM.CTOK (PTMC), Index (DerefOf (Index (\_SB.IETM.PSVA, One)), 0x04))
