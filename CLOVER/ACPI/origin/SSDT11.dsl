 ...
 *
 * Disassembly of SSDT11.aml, Sun Oct 14 20:26:38 2018
 *
 * Original Table Header:
 *     Signature        "SSDT"
 *     Length           0x00003D9C (15772)
 *     Revision         0x01
 *     Checksum         0x2A
 *     OEM ID           "LENOVO"
 *     OEM Table ID     "CB-01   "
...
DefinitionBlock ("", "SSDT", 1, "LENOVO", "CB-01   ", 0x00000001)
{
    ...
    External (_SB_.PCI0.RP01.LREN, UnknownObj)    // (from opcode)
    External (_SB_.PCI0.RP01.PXSX, DeviceObj)    // (from opcode)
    External (_SB_.PCI0.RP01.PXSX._ADR, UnknownObj)    // (from opcode)
    External (_SB_.PCI0.RP01.PXSX.GC6I, MethodObj)    // 0 Arguments (from opcode)
    External (_SB_.PCI0.RP01.PXSX.GC6O, MethodObj)    // 0 Arguments (from opcode)
    External (_SB_.PCI0.RP01.PXSX.LTRE, UnknownObj)    // (from opcode)
    ...
    External (GC6E, MethodObj)    // 1 Arguments (from opcode)
    External (GC6G, MethodObj)    // 0 Arguments (from opcode)
    External (GGIV, MethodObj)    // 1 Arguments (from opcode)
    External (H2OP, MethodObj)    // 1 Arguments (from opcode)
    External (HIGP, UnknownObj)    // (from opcode)
    External (I7CU, UnknownObj)    // (from opcode)
    ...
    External (QUIT, UnknownObj)    // (from opcode)
    External (SGOV, MethodObj)    // 2 Arguments (from opcode)
    External (TCNT, UnknownObj)    // (from opcode)
    External (XXIN, UnknownObj)    // (from opcode)
    External (YG53, UnknownObj)    // (from opcode)

    Scope (\_SB.PCI0.RP01.PXSX)
    {
        OperationRegion (VBOR, SystemMemory, 0x6FF14018, 0x00040004)
    ...
    Scope (\_SB.PCI0.RP01.PXSX)
    {
        OperationRegion (NOPR, SystemMemory, 0x6FF11018, 0x00002018)
    ...
    Scope (\_SB.PCI0.RP01.PXSX)
    {
        ...
        Method (HGON, 0, Serialized)
        {
            ...
            While (LLess (\_SB.PCI0.RP01.LNKS, 0x07))
            {
                ...
                While (Local0)
                {
                    If (LLess (\_SB.PCI0.RP01.LNKS, 0x07))
                    {
                        Stall (0x64)
                        Decrement (Local0)
                    }
        ...
        Method (HGOF, 0, Serialized)
        {
            ...
            Store (LCTL, ELCT)
            Store (One, \_SB.PCI0.RP01.LNKD)
            While (LNotEqual (\_SB.PCI0.RP01.LNKS, Zero))
            {
                Sleep (One)
            }
    ...
    Scope (\_SB.PCI0.RP01.PXSX)
    {
        ...
        Method (GC6I, 0, Serialized)
        {
            ...
            Store (Zero, \_SB.PCI0.LPCB.EC0.GATY)
            Sleep (0x0A)
            Store (\_SB.PCI0.RP01.LREN, \_SB.PCI0.RP01.PXSX.LTRE)
            Store (One, LNKD)
            While (LEqual (GC6G (), Zero))
            {
                Sleep (One)
            }
